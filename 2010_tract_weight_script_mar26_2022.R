...
phl_tracts <- read_sf("C:/Users/Nissim.Lebovits/OneDrive - City of Philadelphia/Desktop/Data/R Scripts and Datasets/General Boundaries/Shapefiles/Census_Tracts",
  ...
  st_transform(crs = st_crs("ESRI:102729"))

#read_sf("C:/Users/Nissim.Lebovits/OneDrive - City of Philadelphia/Desktop/Data/R Scripts and Datasets/General Boundaries/Shapefiles/PZ_Shapefile",
 #             "PZ_Boundaries", stringsAsFactors = FALSE) |>
  #st_transform(crs = st_crs("ESRI:102729"))

pz = read_sf("C:/Users/Nissim.Lebovits/OneDrive - City of Philadelphia/Desktop/Data/R Scripts and Datasets/General Boundaries/Philadelphia_Promise_Zone.geojson") |>
              st_transform(crs = st_crs("ESRI:102729"))
...
pz_tract_agg_demos = left_join(pz_tract_demos_agg, 
  ...
  st_as_sf(crs = st_crs("ESRI:102729"))
