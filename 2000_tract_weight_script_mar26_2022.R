...
vars00 = load_variables(2000, "sf1")
...
vars = c("P001001", #Total population
         "H001001", #Total households
         "P029001", #Total population under 18
         "P019001" #Total!!Households with one or more people under 18 years
)
...
pz_tract_demos_agg = pz_block_demos |>
  ...
  summarize(blocks_tot_pop = sum(P001001),
            blocks_tot_hh = sum(H001001),
            blocks_tot_und18_pop = sum(P029001),
            blocks_tot_hh_w_kids = sum(P019001)) |>
  as.data.frame() |>
...
pz_tract_agg_demos = left_join(pz_tract_demos_agg, 
  ...
  rename(tract_tot_pop = P001001,
         tract_tot_hh = H001001,
         tract_tot_und18_pop = P029001,
         tract_tot_hh_w_kids = P019001) |>
